...
import {Bluetooth, BluetoothSearching, Link2Off, RotateCw} from 'lucide-react-native';
import {Card, Header, Metric, PrimaryButton, Screen, SecondaryButton, SectionHeader, StatusPill, uiStyles} from '../../components/ui';
import {WEARABLE_DEVICE_NAME, WEARABLE_SERVICE_UUID, WEARABLE_TELEMETRY_UUID} from '../../services/ble/wearableBleService';
...
export function WearableDetailScreen({navigation}: any) {
  ...
  return (
    <Screen>
      ...
      <Card>
        <Text style={uiStyles.value}>Not yet measured by firmware</Text>
        ...
        <Text style={uiStyles.body}>Temperature: {t?.temperatureC ?? 'Unavailable'}</Text>
